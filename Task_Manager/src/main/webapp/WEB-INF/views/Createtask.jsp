...
<body style="font-family: tahoma;">
		...
		<nav class="bg-dark text-light p-3" style="min-width: 250px;">
			...
			<ul class="nav flex-column">
				<li class="nav-item"><a href="dashboard"
					class="nav-link text-light">Dashboard</a></li>
				<li class="nav-item"><a href="tasks-list"
					class="nav-link text-light">Tasks</a></li>
				<li class="nav-item"><a href="createtask"
					class="nav-link text-light">Create Task</a></li>

				<!-- If user is logged in -->
				<c:if test="${not empty sessionScope.loggedUser}">
					<li class="nav-item"><span class="nav-link text-light">Welcome,
							${sessionScope.loggedUser}</span></li>
		...
		<div class="container-fluid p-4">
			...
			<form style="font-family: Tahoma;" action="saveTask" method="post">
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						<label for="title" class="form-label">Title</label> <input
							...
							placeholder="Enter task title"> <input type="hidden"
							id="task_id" name="task_id" class="form-control"
				...
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						<label for="deadline" class="form-label">Deadline</label> <input
							type="date" id="deadline" name="deadline" class="form-control">
					</div>

					<div class="col-md-6 mb-3">
						<label for="priority" class="form-label">Priority</label> <select
							id="priority" name="priority" class="form-select">
				...
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						<label for="assignee" class="form-label">Assign To</label> <select
							id="assignee" name="assignee" class="form-select">
	...
	<footer class="bg-dark text-light text-center p-3">
		...
		<div>
			<a href="https://github.com/NarsingPendharkar"
				class="text-light me-3" target="_blank"> <i class="bi bi-github"></i>
				GitHub
			</a> <a href="mailto:your-email@example.com" class="text-light me-3">
				<i class="bi bi-envelope-fill"></i> mailtonarsing@example.com
			</a> <a href="tel:+1234567890" class="text-light"> <i
				class="bi bi-telephone-fill"></i> +91-9209259092
			</a>
		</div>
	</footer>
</body>
