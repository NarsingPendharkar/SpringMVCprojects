...
<body style="font-family:tahoma;">
  <div class="d-flex">
    ...
    <div id="msg" class="alert alert-danger">
      ...
      <form style="font-family:Tahoma;" action="<c:url value='/saveTask'/>" method="post">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" id="title" name="title" class="form-control" value="${task.title}" placeholder="Enter task title">
          </div>

          <div class="col-md-6 mb-3">
            <label for="description" class="form-label">Description</label>
            <textarea id="description" name="description" class="form-control" rows="3" placeholder="Enter task description">${task.description}</textarea>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="date" id="deadline" name="deadline" class="form-control" value="${task.deadline != null ? task.deadline : ''}">
          </div>
